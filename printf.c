...
/*   Updated: 2023/05/11 02:49:42 by daddy_cool       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	pf_formats(va_list args, const char format)
{
	...
	if (format == 'c')
		...
		len += format_hex(va_arg(args, unsigned int), format);
	else if (format == '%')
		len += nonformat();
	else
		len--;
...
// 	printf("\n");
// 	printf("%i\n",-1);
// // 	ft_printf("(Y9Lk%i`h1X.(U%d*,"%c%u6"%xr.i!No*8z%pJ!h
// // \v%sNzxXX%uC_Ok\v\rD", 1826227172,
// // 457743330, -1280881534, -1306065819, 
// // 37642916, (void *)849345852295461385, "'fc^`.r", -1112964109);
// // 	printf("\n=========================\n");
// // 	printf("(Y9Lk%i`h1X.(U%d*,"%c%u6"%xr.i!No*
// // 8z%pJ!h\v%sNzxXX%uC_Ok\v\rD", 1826227172,
// // 457743330, -1280881534, -1306065819, 
// // 37642916, (void *)849345852295461385, "'fc^`.r", -1112964109);
// 	/*
